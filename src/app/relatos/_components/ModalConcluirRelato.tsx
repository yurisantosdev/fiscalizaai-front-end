...
interface ModalConcluirRelatoProps {
  decodigo: string
}

export default function ModalConcluirRelato({
  decodigo
}: ModalConcluirRelatoProps) {
  ...
  return (
    <Modal
      htmlFor="modalConcluirRelato"
      name="Resolver Relato"
      loading={loading}>
      ...
      <span className="text-lg text-center font-extralight text-black flex justify-center items-center gap-1">
        ...
        <p className="font-bold">Resolvido!</p>
      </span>
